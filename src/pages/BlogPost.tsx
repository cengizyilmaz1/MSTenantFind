          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-8 text-slate-500 dark:text-slate-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-slate-900 dark:text-white block">{post.readTime} min read</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="font-bold text-slate-900 dark:text-white block">{post.category}</span>
